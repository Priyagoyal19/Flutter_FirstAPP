...
class _ForgetpageState extends State<Forgetpage> {
  ...
  List imageList=[
    {"id":1,"image_path":'assets/images/forget1.jpg'},
    {"id":2,"image_path":'assets/images/forget2.jpg'},
    {"id":3,"image_path":'assets/images/forget3.jpg'}
  ];
                  ...
                  children: [
                    Padding(
                      ...
                      child: Align(
                          ...
                          child: Text("Forget Your Password",style: TextStyle(fontSize:25),)),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(left:15),
                      child: Text(" We will send link to reset the password to your email",style: TextStyle(color: Colors.grey,fontSize:17),),
                    ),
                  ],
                ),
